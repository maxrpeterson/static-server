...
const server = http.createServer((req, res) => {
  ...
  fs.stat(reqFileUri, (err, stats) => {
    if (err) {
      ...
      res.writeHead(200, {'Content-Type': MimeTypes[path.extname(reqFileUri)]});
      fs.createReadStream(reqFileUri).pipe(res);
    }
  });
});
